...
public class DuckerLoggerAdapter extends LoggerAdapterAbstract {
    ...
    public DuckerLoggerAdapter(String name) {
        super(name);
    ...
    public String getType() {
        return "Log4j2 (via Ducker)";
    }

    @Override
    public void catching(Level level, Throwable t) {
        this.logger.catching(DuckerLoggerAdapter.LEVELS[level.ordinal()], t);
    }
    ...
    public void log(Level level, String message, Object... params) {
        this.logger.log(DuckerLoggerAdapter.LEVELS[level.ordinal()], message, params);
    }

    @Override
    public void log(Level level, String message, Throwable t) {
        this.logger.log(DuckerLoggerAdapter.LEVELS[level.ordinal()], message, t);
    }
